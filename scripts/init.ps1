...
function Run-GCPerfSim      { Invoke-Expression ((Join-Path $PSScriptRoot "run-gcperfsim.ps1"      ) + ""         ) }
function Debug-GCPerfSim    { Invoke-Expression ((Join-Path $PSScriptRoot "debug-gcperfsim.ps1"    ) + ""         ) }
...
function Enable-Datas       { Invoke-Expression ((Join-Path $PSScriptRoot "enable-datas.ps1"       ) + ""         ) }
function Enable-Segment     { Invoke-Expression ((Join-Path $PSScriptRoot "enable-segment.ps1"     ) + ""         ) }
