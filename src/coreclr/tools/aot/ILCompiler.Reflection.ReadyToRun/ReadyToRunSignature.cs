...
namespace ILCompiler.Reflection.ReadyToRun
{
    ...
    /// </summary>
    public class SignatureDecoder : R2RSignatureDecoder<string, string, string, TextSignatureDecoderContext>
    {
        ...
        // Goal: Move the parsing logic (i.e. read the bytes, determining which path to go)
        // up to R2RSignatureDecoder, and delegate the string specific processing to a strategy
        // where that strategy object can be replaced and do something else.

        // Ignore about the fact that 
